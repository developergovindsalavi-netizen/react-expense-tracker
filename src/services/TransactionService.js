...
async function addTransaction(transaction) {
    ...
    const newTransactionData = [...transactionData, transaction];
...
async function deleteTransaction(id) {
    ...
    const newTransactionData = transactionData.filter((item) => item.id !== id);
...
async function updateTransaction(transaction) {
    ...
    const transToUpdate = transactionData.find((item) => item.id === transaction.id);
